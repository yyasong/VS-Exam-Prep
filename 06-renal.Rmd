...
-   [Improved and validated methods to evaluate the salvageability of
    ...
    grail of this disease process.]{.ul}

**Let's go through some of these:**

[Renal Resistive index:]{.ul}
...
[Trajectory of kidney function]{.ul}
...
[Comparison of kidney morphology with kidney function]{.ul}
...
-   CORAL trial [@cooperStentingMedicalTherapy2014]
    ...
    -   947 patients (80 % had unilateral disease) who met the following
        ...
        -   Unilateral or bilateral atherosclerotic renal artery
            ...
            peak systolic velocity >300 cm/second if diagnosed by duplex
            Doppler ultrasonography, Luminal narrowing >80 % if
...
-   Limitations on existing treatment data:
    ...
    -   [Considerable selection bias]{.ul} -- For the most part, the
        patients enrolled in these trials did **not** meet the criteria
    ...
    -   [Results of the trials differ substantially from observational
        reports of "high-risk" subsets]{.ul}
...
-   [Percutaneous renal angioplasty/stenting]{.ul}in addition to medical
    therapy
...
-   [Surgical revascularization]{.ul} used in addition to medical
    therapy
...
-   [Revascularization]{.ul} Goal: control of hypertension
...
-   [Without]{.ul} stent placement... unlike PTA for atherosclerotic RAS
