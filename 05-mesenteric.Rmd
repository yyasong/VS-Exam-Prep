...
1.  [Resuscitation]{.ul}. Fluids, fluids, fluids. These patients are
...
2.  [Antibiotics]{.ul}. These patients are not usually septic on initial
...
3.  [Heparin]{.ul}. In the absence of a clinical contraindication, these
...
approach.[@kazmersOperativeManagementAcute1998]
...
1.  [Resect frankly necrotic bowel and contain gross spillage]{.ul}.
...
2.  [Revascularization]{.ul}. SMA embolectomy is the initial management
...
3.  [Re-assess bowel viability]{.ul}. Clinical status permitting, 20-30
...
4.  [Proceed with temporizing or definitive bowel repair]{.ul}.
...
5.  [Consider second-look laparotomy.]{.ul} Many times, bowel may look
...
[Short retrograde aorto-SMA bypass:]{.ul}
...
[Long retrograde R iliac-SMA bypass ("C-loop"):]{.ul}
...
[Antegrade supraceliac aorta-SMA bypass:]{.ul}
...
[Retrograde open mesenteric stenting (ROMS)]{.ul}
...
pharmacomechanical thrombectomy)]{.ul}
...
eventual [unintentional]{.ul} weight loss.
