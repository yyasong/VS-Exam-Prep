...
endoleak). Can detect endoleaks, sac expansion, and limb occlusion.
Migration difficult to assess given challenge of renal arteries
visualization in a long axis view of the aorta.

Type II endoleaks with stable sac size can continue surveillance with
duplex.[@chaikof2018; @karthikesalingam2012] Any findings concerning for
growth, endoleak or flow in the sac should have confirmatory CTA
performed.

Surveillance duplex does not reliably detect graft migration.\@busch2009
