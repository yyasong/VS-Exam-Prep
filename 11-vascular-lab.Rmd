...
First let's define [Stenosis:]{.ul} A hemodynamically significant
...
[Normal ECA vs ICA waveform:]{.ul} The external carotid artery waveform
...
[Parameters for ICA stenosis]{.ul}: These are a few numbers that are
...
[Parameters for when surgery indicated:]{.ul}
...
[Pathologies:]{.ul} Stenosis (plaque), dissection (flap), aneurysms
...
[Fibromuscular dysplasia]{.ul} of the internal carotid arteries affects
...
[Subclavian steal:]{.ul} Subclavian steal occurs when a proximal
...
[Innominate stenosis:]{.ul} A phenomenon that is related to this, is
...
-   [MCA spasm (severe PSV>200)]{.ul}: Can be seen in sickle cell
    disease with studies indicating a strong correlation between mean
    velocities of >200cm/s and the rate of stroke in children with
...
-   [Cerebral ischemia during CEA:]{.ul} Comparing transcranial Doppler
...
[Peripheral]{.ul}: Normal waveforms are indicative of high resistance
...
-   **Normal parameters:** Normal pressure gradient between the right
    and left brachial pressures is \<20 mmHg. Normal finger pressure
...
[Arterial TOS:]{.ul} Results from compression of the subclavian artery
...
[Photoplethysmography (PPG)]{.ul} uses an infrared light to illuminate
...
[Raynaud's:]{.ul} Vasospastic disorder characterized by temporary
vasospasm. Diagnosis may be assisted by decrease in digital waveforms
with immersion of the hand in cold water.

[Thromboangiitis obliterans:]{.ul} Is a segmental non-atherosclerotic
...
[Fistulas]{.ul}: Ultrasound is one of the key modalities used in
...
[Assessment for fistula suitability for dialysis:]{.ul} Rule of 6's: At
...
[Waveform:]{.ul} The arterial waveform should demonstrate very low
...
[Pseudoaneurysms:]{.ul} Pseudoaneurysms commonly occur when a puncture
...
[Steal syndrome:]{.ul} Hemodialysis-related steal, also known as
...
[Central venous stenosis:]{.ul} Venous outflow stenosis is the most
...
[Stenosis of fistula:]{.ul} Arterial and mid-graft stenosis can also
...
[ABIs:]{.ul} Ankle-brachial index measurement requires calculating the
...
both ratios. Normal ABI \>0.9, severe disease indicated by ABI\<0.5, and
CLI by ABI\<0.3. The ankle-brachial index in diabetic patients is
...
[TcPO2:]{.ul} When there is significant tissue loss, preventing TBI
...
[PVRs:]{.ul} Pulse volume recordings. Normal PVR waveforms have a rapid
...
[Exercise Test:]{.ul} During exercise testing, patients are placed on a
...
[Parameters associated with poor wound healing:]{.ul} Considering these
...
[Restenosis/Graft surveillance]{.ul}: Suggested ultrasound surveillance
...
concern is suggested by PSV \>300 cm/s, Vr \>3.5, a graft flow velocity
\<45 cm/s or a drop in ABI \>0.15.[@bandykHemodynamicsVeinGraft1988]
...
[Pseudoaneurysms (particularly femoral):]{.ul} Gray-scale
...
[Dissections:]{.ul} Characteristic ultrasound findings on color Doppler
...
[Adventitial cystic disease:]{.ul} This is a rare (but often tested)
...
popliteal artery will demonstrate an anechoic *intraluminal* region with
...
[Bakers Cyst]{.ul}**:** which is a benign, cystic structure found in the
...
[Popliteal entrapment syndrome:]{.ul} decrease in ABI or loss of distal
...
[S/p EVAR:]{.ul} Surveillance color duplex ultrasound is safe if CT
...
[CIA aneurysms:]{.ul} SVS defines CIA aneurysms as any permanent,
localized dilatation of the iliac artery \>1.5 cm in diameter (diameter
1.5x the normal diameter)

[Para-anastomotic pseudoaneurysms:]{.ul} As previously discussed
(reported in up to 0.5% to 10% of cases)

[Penetrating aortic ulcers:]{.ul} Describes an ulcerating
...
[Dissections:]{.ul} (as already discussed) a dissection flap is usually
...
[Dissections:]{.ul} Rare without concomitant aortic dissection.

[Aneurysms:]{.ul} Rare. Repair \>2 cm celiac, hepatic, SMA aneurysms and
\>3 cm splenic and renal.

[Median arcuate ligament syndrome:]{.ul} MALS can cause significantly
...
[Portal vein:]{.ul} Normal portal venous flow is hepatopetal (toward the
...
[Renal Pathologies:]{.ul} ostial (atherosclerotic) vs mid-artery (FMD)

[Atherosclerotic stenosis:]{.ul} PSV>200 cm/s predictive of \>60%
...
[FMD:]{.ul} As discussed for the carotids, FMD manifests as beaded
...
[Normal venous waveforms:]{.ul} Normal flow patterns of iliac and
...
[Reflux:]{.ul} Venous reflux due to valvular incompetence is best
...
[Perforator veins:]{.ul} Perforator veins connect the deep and
...
[Ovarian vein reflux:]{.ul} The ultrasound evaluation of pelvic
...
[May Thurner]{.ul}**:** Also known as iliac vein compression syndrome,
...
[Thrombosis:]{.ul} Characteristics of acute thrombus are an echolucent
...
[Venous TOS:]{.ul} Venous thoracic outlet syndrome is thrombosis or
...
[EHIT or Endovenous Heat Induced Thrombosis:]{.ul} S/p endovenous
