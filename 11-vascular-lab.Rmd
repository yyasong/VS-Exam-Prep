...
[Normal spectral waveform:]{.underline}
...
[Low vs high resistance waveforms:]{.underline}
...
CT - limitations include ionizing radiation, iodinated contrast and not
appropriate in patients with CKD.

MRA - performed with gadolinium-based contrast and not appropriate in
patients with ESRD.
...
[Upper Extremity:]{.underline}

-   **Normal parameters:** Normal pressure gradient between the right
    and left brachial pressures is \<20 mmHg. Normal finger pressure is
    \>80% of the ipsilateral brachial systolic pressure. So a normal
...
notch on the downslope during diastole.
