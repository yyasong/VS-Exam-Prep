...
triangle
or patch
vein. & \begin{minipage}[t]{\linewidth}\raggedright
-Unable to
decompress
venous
c
...
\item
  ...
  \item
    ...
    haemorrhage.
    \citep{grunwaldCatheterDirectedThrombolysisTreatment2004}
  \item
...
\subsubsection{Important differentials for aTOS}\label{important-differentials-for-atos}}
...
\subsubsection{Most common causes of aTOS -~The different Anatomical Abnormalities causing aTOS (incidence \%)}\label{most-common-causes-of-atos---the-different-anatomical-abnormalities-causing-atos-incidence}}
...
\item
  Enlarged C7 transverse process (1\%) \citep{boll122ThoracicOutlet2019}
\end{itemize}
