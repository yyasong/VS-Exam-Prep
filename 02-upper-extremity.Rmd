...
|                     |     scalene         |     decompress      |
|                     |     triangle access |     venous          |
|                     |     and debulking   |     compression or  |
|                     |     and cervical    |     visualize vein  |
|                     |     rib resection   |     adequately      |
|                     |                     |                     |
|                     | -   Required for    | -   Cosmetically    |
|                     |     aTOS if         |     less appealing  |
|                     |     arterial        |                     |
|                     |                     |                     |
|                     | reconstruction      |                     |
|                     | necessary           |                     |
+---------------------+---------------------+---------------------+
| Infrac lavicular    | -   Good access for | -   Unable to       |
| [\@ siracuseI       |     venous          |     expose          |
| nfraclavi cularFirs |                     |     subclavian      |
| tRib2015]           | decompression       |     artery or       |
|                     |                     |     decompress      |
|                     | -   Allows for      |     brachial        |
|                     |     excision of     |     plexus.         |
|                     |     subclavius      |                     |
...
|                     |                     |     less appealing  |
+---------------------+---------------------+---------------------+
| Parac lavicular     | -   Useful if mixed | -   Requires two    |
|                     |     etiology TOS to |     incisions one   |
