...
| Type        | T           | Su p        | In f        |
|             | r           | r           | r           |
|             | ansaxillary | aclavicular | aclavicular |
+=============+=============+=============+=============+
| Advantages  | C           | -Good for   | -Good       |
|             | osmetically | scalene     | access for  |
|             | more        | triangle    | venous d    |
|             | appealing   | access and  | e           |
|             | as it has a | debulking   | compression |
|             | limited     | and         |             |
|             | hidden scar | cervical    | -Allows for |
|             |             | rib         | excision of |
|             |             | resection   | subclavius  |
|             |             |             | muscle and  |
|             |             | -Required   | c o s       |
|             |             | for aTOS if | t           |
|             |             | arterial r  | oclavicular |
|             |             | e           | ligament    |
|             |             | c           |             |
|             |             | onstruction |             |
|             |             | necessary   |             |
...
| i           | to          | decompress  | expose      |
| sadvantages | visualise   | venous      | subclavian  |
|             | the         | compression | artery      |
|             | anatomy,    | or          |             |
|             | dependent   | visualise   | -Difficult  |
|             | on good     | vein        | to access   |
|             | assistance  | adequately  | most        |
|             |             |             | posterior   |
|             | -Risk of T1 | -   c       | aspect of   |
|             | nerve root  | osmetically | rib         |
|             | injury,     |     less    |             |
|             | subclavian  |             | \-          |
|             | vein injury |   appealing | C           |
|             | and         |             | osmetically |
|             | arterial    |             | less        |
|             | injury with |             | appealing   |
|             | limited     |             |             |
|             |             |             |             |
|             | exposure to |             |             |
|             | repair      |             |             |
