...
**1. Intrathoracic Zone:** Inclusive of the aortic arch and its
...
**Right Subclavian Artery:** For proximal artery exposure a medial
...
**Axillary Artery:** Exposure is gained through an infraclavicular
...
| lavicular      |     scalene        |     decompress venous |
|                |     triangle       |     compression or    |
|                |     access and     |     visualize vein    |
|                |     debulking and  |     adequately        |
|                |     cervical rib   |                       |
|                |     resection      | -   Cosmetically less |
|                |                    |     appealing         |
|                | -   Required for   |                       |
|                |     aTOS if        |                       |
|                |     arterial       |                       |
...
| lavicular [@   |     for venous     |     subclavian artery |
| siracuseI      |     decompression  |     or decompress     |
| nfraclavi      |                    |     brachial plexus.  |
| cularFirs      | -   Allows for     |                       |
| tRib2015]      |     excision of    | -   Difficult to      |
|                |     subclavius     |     access most       |
|                |     muscle and     |     posterior aspect  |
|                |                    |     of rib            |
|                |    costoclavicular |                       |
|                |     ligament       | -   Cosmetically less |
|                |                    |     appealing         |
+----------------+--------------------+-----------------------+
| Parac          | -   Useful if      | -   Requires two      |
| lavicular      |     mixed etiology |     incisions one     |
|                |     TOS to         |     above and below   |
|                |     adequately     |     the clavicle      |
|                |     decompression  |                       |
|                |     all            |                       |
|                |     neurovascular  |                       |
|                |     structures     |                       |
