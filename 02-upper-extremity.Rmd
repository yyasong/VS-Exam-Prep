...
-   **Bovine Arch:** Where the inominate and left common carotid
    arteries share a common origin.

-   **Abberant Vertebral Artery:** Where the vertebral artery arises
...
**This is discussed in detail here:** \@ref(peripheral), **so we will go over some important specifics for upper extremity vascular injury.**
...
|                |                   |     or patch vein.   |
+----------------+-------------------+----------------------+
| Suprac         | -   Good for      | -   Unable to        |
| lavicular      |     scalene       |     decompress       |
|                |     triangle      |     venous           |
...
|                |     necessary     |                      |
+----------------+-------------------+----------------------+
| Infrac         | -   Good access   | -   Unable to expose |
| lavicular [\@  |     for venous    |     subclavian       |
| siracuseI      |     decompression |     artery or        |
| nfraclavi      |                   |     decompress       |
| cularFirs      | -   Allows for    |     brachial plexus. |
| tRib2015]      |     excision of   |                      |
|                |     subclavius    | -   Difficult to     |
|                |     muscle and    |     access most      |
|                |                   |     posterior aspect |
...
|                |                   |     less appealing   |
+----------------+-------------------+----------------------+
| Parac          | -   Useful if     | -   Requires two     |
| lavicular      |     mixed         |     incisions one    |
|                |     etiology TOS  |     above and below  |
|                |     to adequately |     the clavicle     |
|                |     decompression |                      |
|                |     all           |                      |
|                |     neurovascular |                      |
|                |     structures    |                      |
