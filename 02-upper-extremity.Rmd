...
+===========+===========================+=========================+
| **Transa  | Cosmetically more         | Difficult to visualize  |
| xillary** | appealing as it has a     | the anatomy, dependent  |
...
+-----------+---------------------------+-------------------------+
| *         | Good for scalene triangle | Unable to decompress    |
| *Supracla | access and debulking and  | venous compression or   |
| vicular** | cervical rib resection    | visualize vein          |
|           |                           | adequately              |
|           | Required for aTOS if      |                         |
|           | arterial reconstruction   | Cosmetically less       |
|           | necessary                 | appealing               |
+-----------+---------------------------+-------------------------+
| *         | Good access for venous    | Unable to expose        |
| *Infracla | decompression             | subclavian artery or    |
| vicular** |                           | decompress brachial     |
|           | Allows for excision of    | plexus.                 |
|           | subclavius muscle and     |                         |
|           | costoclavicular ligament  | Difficult to access     |
...
|           |                           | appealing               |
+-----------+---------------------------+-------------------------+
| **Paracla | Useful if mixed etiology  | Requires two incisions  |
| vicular** | TOS to adequately         | one above and below the |
