...
|                      |                      |     or patch vein.   |
+----------------------+----------------------+----------------------+
| Suprac lavicular     | -   Good for scalene | -   Unable to        |
|                      |     triangle access  |     decompress       |
|                      |     and debulking    |     venous           |
|                      |     and cervical rib |     compression or   |
|                      |     resection        |     visualize vein   |
|                      |                      |     adequately       |
|                      | -   Required for     |                      |
|                      |     aTOS if arterial | -   Cosmetically     |
|                      |                      |     less appealing   |
|                      | reconstruction       |                      |
|                      | necessary            |                      |
+----------------------+----------------------+----------------------+
| Infrac lavicular [\@ | -   Good access for  | -   Unable to expose |
| siracuseI nfraclavi  |     venous           |     subclavian       |
| cularFirs tRib2015]  |                      |     artery or        |
|                      | decompression        |     decompress       |
|                      |                      |     brachial plexus. |
|                      | -   Allows for       |                      |
|                      |     excision of      | -   Difficult to     |
|                      |     subclavius       |     access most      |
|                      |     muscle and       |     posterior aspect |
|                      |                      |     of rib           |
|                      | c ostoclavicular     |                      |
|                      | ligament             | -   Cosmetically     |
|                      |                      |     less appealing   |
+----------------------+----------------------+----------------------+
