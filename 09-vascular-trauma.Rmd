...
**Starting with the basics, what do you tell them are the hard and soft
...
**What are the initial principles of managing a bleeding extremity?**
...
Uh, I think as you pointed out appropriately, you sort of debris the
vessel back to make sure you're on. Uninjured vessel. And then, and then
performing a, an inner position graph most commonly, I mean, that's the,
uh, most commonly venous injuries. Uh, you know, the veins are more
compliant and, uh, they're larger if you will, most of the time.

And oftentimes you can get away with a lateral venography, uh, you know,
uh, primarily repairing the veins and then sometimes the upper
extremities, the brachial artery has more redundancy. If you, if it's a
[00:25:00] very focal injury, uh, you can get a little stretch if you
will, and, and, and get those, the brachial artery back together
primarily.

But, uh, you know, I suspect, um, uh, she's 90% or more of a, in my
experience, uh, these are, they require. You know, an interposition
graph and then the conduit, um, you know, we, uh, because most of the,
uh, wartime injuries were contaminated and quite dirty. Uh, we deferred
to saphenous vein and more than 90% of cases, more than 95% of cases as
the conduit, we felt like autologous vein was, uh, was, was, was the
preference.

I think if one's in a, in a pinch, um, and, uh, you can't find a vein.
Um, you don't have time to harvest vein. The wound is not too
contaminated. Uh, if it's a proximal, uh, uh, axillary or subclavian,
[00:26:00] uh, proximal, femoral, or iliac, uh, then I think using a
prosthetic, either Dacron or expanded PTFE, a Gore-Tex is also
acceptable.

It's it's, uh, uh, acceptable and there's some civilian literature that
says that a PTFE is actually. Not just acceptable, but is, uh, you know,
is, is, uh, quite suitable and maybe even better than vain. Uh, that's
not been our experience, uh, in the deployed setting, but, um, but I
think, you know, keep all of those things in mind as you're, as you're
setting up to, to this next phase of the, of the operation.

Well, now that we've covered the principles of managing peripheral
vascular injuries, we're going to dive in a little deeper on each level
of kind of peripheral vascular injury. And first we're going to talk
about junctional hemorrhage, kind of our, one of our biggest fears and
most difficult to deal with.

Um, so dress me, take me through you have a hematoma in the groin or
pelvis kind of at, or above the inguinal ligament. [00:27:00] Uh, what
are the best ways to get control of this? Yeah, so the, uh, I think for
the listeners, the junctional injuries, um, as you referred to are those
injuries that are in the junction areas between the torso and the
extremities.

So that'd be the distal, external iliac and common femoral and, uh, in
the lower portion. And, uh, and then the some Clavey and an axillary in
the, in the upper extremities, um, for the, for the iliac artery, um, or
the, or even just the proximal common femoral, um, I think a
retroperitoneal exposure. Uh, to the, uh, to the, um, you know, the
lower quadrant of the abdomen, we sometimes refer to that as a
transplant incision, uh, is, is quite suitable depending upon the injury
pattern.

I think as I alluded to before, uh, try not to ever find yourself having
underestimated, uh, the, the, the exposure you're going to need.
[00:28:00] So, uh, if, if it truly is a groin hematoma, um, and you
think, ah, this, this is a, this could be common femoral or external
iliac. Uh, then in those cases, uh, either a transplant incision to, uh,
you know, in a retroperitoneal fashion, Uh, uh, to, uh, to get that
controlled, um, you know, that will allow one to get up to the common
iliac, uh, most often, uh, and there's no harm in those cases, uh, to
just doing a laparotomy and finding it through the abdomen to, um, it
really depends upon the, the injury, um, and, and the scenario you find
yourself in.

Um, um, but that's, that's sort of how I would, uh, would approach, uh,
you know, common femoral or district Elliot Carter injury. Great. And,
um, and so what if you encountered a, um, internal iliac injury kind of
deep in the pelvis that, uh, you weren't able to control, um, [00:29:00]
w what are the consequences of, of litigating that?

Well, that is a, you know, that's real tiger country, of course, as, as
you know, um, uh, sort of internal iliac, uh, vessels, and I think, uh,
In those cases, uh, it's really damaged control. One of the things we
haven't mentioned is the important tenant that, uh, as we talk about one
of the key tenants, maybe arguably one of the most important tenants,
uh, after hemorrhage control, um, in damage control, vascular is, is
ligation.

Um, oftentimes, you know, we've talked a lot about setting up for a
vascular repair, but, uh, but one of the reasons to check with
anesthesia and to assess the whole of the patient is to recognize that
in some scenarios, uh, the best thing is legation. And, uh, and then
dealing with whatever consequences may result from that.

But, uh, keeping in mind sort of life over limb, um, and not being too
[00:30:00] aggressive about trying to do some sort of exposure and
repair of, uh, of a vessel that takes hours and many, many units of
blood. So in that context, I think, uh, Finds bleeding from, from the
internal, what we call the hypogastric vessels.

I think ligating those, uh, uh, is, is quite acceptable. Um, there can
be instances of Helvic aschemia um, but if the other, if the
contralateral iliac artery is, is open, uh, then, uh, that's quite rare,
I think to, to, to really create pelvic ischemia, uh, litigating one of
the, uh, the iliac arteries. Um, again, that really is, it depends upon
what injuries in front of you and how the patient is doing as a whole.

Um, and, and not uncommonly in those situations. One is dealing with
artery and vein cause they're right there together. And as I mentioned,
that's a, that's a real tiger country. [00:31:00] Uh, if that's
happening in those situations, you know, the tenants of exposure, light,
uh, two suctions. Don't use too small of a needle, you know, that's
where the sh needle, uh, you know, uh, don't try to be to finesse those
too much in the, in the pelvis because you won't be able to see your
needle.

Uh, and, and it's, it's a mess. So the sh needle, for example, um, the,
the blood tip sh needle is on a three or four O proline is, is really
nice in those situations because the needle is big enough to actually
see and work with, uh, in a pool of blood. Let's take that same engine.
Let's take the same injury and move it now to the external Lex.

Um, so what are the consequences of lagging, the external Lex and what
are some of your options? Yeah. Now in this situation, the external
iliac, I think because it's the axial vessel to that extremity, I think.
I would not like gate that with such impunity. Um, I think in those
situations, uh, [00:32:00] controlling it and, uh, and making that
assessment, um, of whether or not to repair it, uh, uh, is, is
paramount.

I think that should do everything you can. I think that the consequences
of ligating an external iliac artery, uh, are going to be, you know,
significant and include, uh, quite proximal, um, you know, extremity,
ischemia, including thigh, and probably need for, uh, certainly an above
knee amputation of not, uh, disarticulation of the hip.
...
doing or how your casualty flow, your capabilities are also using a
temporary vascular shunt of some to, uh, as a damage control. Maneuver
is a, is another option for the external.

Uh, what advice do you have for us on replacing the issue? Because many
times people have a place [00:33:00] to shut until it's time that they
need to, and, uh, they can be quite tricky. Do you have any advice for
our listeners? Well, I think the, um, um, yeah, I think that's a great
question. Uh, you know, in the, in the proximal vessels of the
extremity, the, the temporary avascular Sean's are quite useful.

I think it's important to know what shunts you have available in a given
place. So, uh, this. Something to, to stroll through the operating room
or your stock room wherever you are, uh, when it's not busy and say,
Hey, what type of Acular shunts do we have here? There are four or five
different types of shuns, um, from anything from what's referred to as
the Javid shunt to the Sundt shunt, S U N D T a there's the Argyle
shunt.

Um, and, and then, you know, there can be makeshift, shuns, uh, such as
