...
Likewise, trying to make sure that the thrombus has been removed. I
mentioned this earlier from that distal vessel, I think is very
important before you placed the shunt in so that you try to clear
as much of the thrombus as you can, proximal and distal, and then place
that shunt in and secure either with a heavy silk tie or
plastic vessel loops.

Most of those shunts, you can listen with the Doppler and you will
see arterial flow in it. You can listen on the surface of the
plastic shunt with either a little water or acoustic gel. And you
can hear the arterial flow in those shunts. 

**And so, just for our military docs out there, if they're deploying to a
roll to and their supply Sergeant calls them and ask
them "what kind of shunts do you want us to have? What sizes and what types?" -- what recommendations would you give
to make sure that you have them on hand?**

Yeah, it's a great question for now and it's a challenge for us in the future. I think here and now, I would
I would try to really make sure that the roll to surgeon
put his or her hands on Argyle shunts.

So the Argyle shunts come four in a container -- there's a 12 French, 14 French, 10 French, and 8 French, all sort of in the same container. And I think 
seeing those and making sure you have those, especially the larger 14 French Argyle can work on an iliac. 

Probably, if you had to go to one, it would be this one and also look for a 14 French chest tube -- and say, "well these are my shunt options, I want these, and I need to have these available." Some other shunts like the Sundt and Javid shunt, those are other ones you could ask for, but then you would only have one size. Those and the thrombectomy catheters is what one would need. I think it's very difficult to do an effective arterial
repair without the ability to do the thrombectomy, proximal and distal, because you will be repairing that segment into
thrombosed vessel with thrombosed inflow and thrombosed outflow.

I think you need to get that vascular repair kit, if
you will, assembled and communicated with your scrub team ahead
of time to include the specific items so when I say "heparin saline" it's this dose I want, these are the shunts I might use, have the SH needle and smaller ones, thrombectomy catheters, and so on with the series of tools that you may find yourself needing. Keep in mind, we don't use pulmonary artery catheters much anymore, but they can be used as a thrombectomy catheter in a pinch. And then those thrombectomy catheters can be used as good proximal inflow control. 

You can insert a large thrombectomy catheter, proximal, and inflate the balloon with
a three-way stopcock and that will afford you inflow control in a
pinch, as well. 

**So say you're having a patient transferred in from the
roll to, to the higher level of care. Do you recommend these
patients be heparinized if able when they have shunts, whether arterial or venous?"**

If they can be, then yes, that's tricky. As you can imagine. It's sort of similar to: "can one use heparin for
the arterial repair itself?" That depends upon whether or
not there are other injuries -- a head injury or torso injury, massive
soft tissue bleeding or injury. In those cases, I would not shunt put those patients on heparin because you will cause bleeding. 

So our experience is that the temporary vascular shunts in the
proximal vessels, which really means, above the knee and proximal, and above the elbow and proximal. 
Those shunts will stay patent without heparin for four to six
hours, because they're high flow vessels and I was once taught that
the best anticoagulant is flow.

If you have high flow and those larger proximal vessels,
