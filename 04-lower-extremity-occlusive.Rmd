...
+----------+----------+----------+----------+----------+----------+
| C l as s | -   \*P  | Se n s o | -        | A r te r | Ve n o   |
| i f ic a |     r o  | ry L o   |          | i al Si  | us Si g  |
| t i on   |     g no | ss       | \*       | g n al   | n al     |
|          |     s i  |          |          |          |          |
|          |     s    |          | M u s c  |          |          |
|          |          |          | le We a  |          |          |
|          | \*\*     |          |          |          |          |
...
| e n ed   |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| a . M a  | S al v a | M i n i  | N o ne   | -   /-   | \+       |
| r g i n  | g e a b  | m al ( t |          |          |          |
| a l ly   | le if p  | o e s)   |          |          |          |
|          | r o m p  | or n o   |          |          |          |
|          | t ly t r | ne       |          |          |          |
|          | e a t ed |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| b . Im m | S al v a | M o re t | M i l d, | -   /-   | \+       |
| e d i a  | g e a b  | h an t o | m o d e  |          |          |
| t e ly   | le w i   | e s, as  | r a te   |          |          |
|          | th i m m | s o c i  |          |          |          |
|          | e d i a  | a t ed w |          |          |          |
|          | te r ev  | i th r e |          |          |          |
|          | a s c u  | st p a   |          |          |          |
...
|          | a t i on |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| I I I.   | M a j or | P r o \| | P r o \| | \- \|    | \-       |
|          | \| t i s | f o u n  | f o u n  |          |          |
| \|       | s ue l o | d, an e  | d, p a r | \|       | \| v     |
|          | ss or p  | s t h e  | a l y s  |          |          |
| I rr     | e r m a  | t ic     | is () r  | \|       | \|       |
|          | n e nt n |          | i g o r) |          |          |
| e        | e r ve d | \|       | \|       | C \|     |          |
|          | a m a g  |          |          |          |          |
| v        | e \| i   | \|       | \|       |          |          |
