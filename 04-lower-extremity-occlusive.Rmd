...
+---------+---------+---------+---------+---------+---------+
| C l as  | -   \*P | Se n s  | -       | A r te  | Ve n o  |
| s i f   |     r o | o ry L  |         | r i al  | us Si g |
| ic a t  |     g   | o ss    | \*      | Si g n  | n al    |
| i on    |     no  |         |         | al      |         |
|         |     s i |         | M u s c |         |         |
|         |     s   |         | le We a |         |         |
|         |         |         |         |         |         |
...
| ed      |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+
| a . M a | S al v  | M i n i | N o ne  | -   /-  | \+      |
| r g i n | a g e a | m al (  |         |         |         |
| a l ly  | b le if | t o e   |         |         |         |
|         | p r o m | s) or n |         |         |         |
|         | p t ly  | o ne    |         |         |         |
|         | t r e a |         |         |         |         |
|         | t ed    |         |         |         |         |
+---------+---------+---------+---------+---------+---------+
| b . Im  | S al v  | M o re  | M i l   | -   /-  | \+      |
| m e d i | a g e a | t h an  | d, m o  |         |         |
| a t e   | b le w  | t o e   | d e r a |         |         |
| ly      | i th i  | s, as s | te      |         |         |
|         | m m e d | o c i a |         |         |         |
|         | i a te  | t ed w  |         |         |         |
|         | r ev a  | i th r  |         |         |         |
...
|         | on      |         |         |         |         |
+---------+---------+---------+---------+---------+---------+
| I I I.  | M a j   | P r o   | P r o   | \- \|   | \-      |
|         | or \| t | \| f o  | \| f o  |         |         |
| \|      | i s s   | u n d,  | u n d,  | \|      | \| v    |
|         | ue l o  | an e s  | p a r a |         |         |
| I rr    | ss or p | t h e t | l y s   | \|      | \|      |
|         | e r m a | ic      | is () r |         |         |
| e       | n e nt  |         | i g o   | C \|    |         |
|         | n e r   | \|      | r) \|   |         |         |
| v       | ve d a  |         |         |         |         |
