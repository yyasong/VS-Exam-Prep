...
+----------------+----------------+----------------+----------------+
| **Cl           | **Descripti    | **Findings**   | **Doppler      |
| assification** | on/prognosis** |                | signals**      |
+================+================+================+================+
| **Sensory      | **Muscle       | **Arterial**   | **Venous**     |
| loss**         | weakness**     |                |                |
+----------------+----------------+----------------+----------------+
| I. Viable      | Not            | None           | None           |
|                | immediately    |                |                |
|                | threatened     |                |                |
+----------------+----------------+----------------+----------------+
| II\.           | \              | \              | \              |
| Threatened     |                |                |                |
+----------------+----------------+----------------+----------------+
| a\. Marginally | Salvageable if | Minimal (toes) | None           |
|                | promptly       | or none        |                |
|                | treated        |                |                |
+----------------+----------------+----------------+----------------+
| b\.            | Salvageable    | More than      | Mild, moderate |
| Immediately    | with immediate | toes,          |                |
|                | rev            | associated     |                |
|                | ascularization | with rest pain |                |
+----------------+----------------+----------------+----------------+
| III\.          | Major tissue   | Profound,      | Profound,      |
| Irreversible   | loss or        | anesthetic     | paralysis      |
|                | permanent      |                | (rigor)        |
|                | nerve damage   |                |                |
|                | inevitable.    |                |                |
|                | Cyanosis may   |                |                |
...
-   Studies:
    ...
    -   TOPAS trial -- larger RCT which enrolled patients who had an
        ...
        [@ourielComparisonRecombinantUrokinase1998a]
