...
| G rade/Category | Clinical Description                                        |
|-----------------|-------------------------------------------------------------|
...
| \>75%             | \>400                              | \>4            | Damped, m onophasic, reduced PSV |
...
+----------+----------+----------+----------+----------+----------+
| -   \    | **Pro g  | S ensory | -   \*   | Arte     | Ve nous  |
|     \* C | n osis** | Loss     |          | rial Si  | Si gnal  |
|          |          |          | Muscle   | gnal     |          |
| lassif i |          |          | We a     |          |          |
|          |          |          |          |          |          |
| ca t i   |          |          | kne      |          |          |
...
| atened   |          |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| a\. M a  | Sal v a  | M inimal | None     | +/-      | \+       |
| r g      | geable   | (toes)   |          |          |          |
| inally   | if p r   | or none  |          |          |          |
|          | omptly t |          |          |          |          |
|          | reated   |          |          |          |          |
+----------+----------+----------+----------+----------+----------+
| b\. Im m | Sal v a  | More     | Mild, m  | +/-      | \+       |
| e d      | geable   | than     | o derate |          |          |
| iately   | with i m | toes, as |          |          |          |
|          | m ediate | s o      |          |          |          |
|          | rev      | ciated   |          |          |          |
|          | ascula r | with     |          |          |          |
|          | i zation | rest     |          |          |          |
...
| Irr e v  | tissue   | found,   | found, p |          |          |
| e rsible | loss or  | an e s   | a r      |       |  | |   v    |
|          | p e r    | thetic   | alysis   |          |          |
| |        | manent   |          | ()       | |        | |        |
|          | nerve d  |       |  | rigor)   |          |          |
|     |    | amage\|  |       |  | \|       | C \|     |          |
